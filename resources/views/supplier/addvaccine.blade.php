...
<head>
    ...
    <title> Supplier| add Vaccine</title>
                            ...
                            <div id="id01" class="modal">
                                ...
                                @csrf
                                    <div class="imgcontainer">
                                        ...
                                        <div class="s">
                                            <input type="number"style="width: 49.5%; font-size: 17px; height: 40px;" placeholder="Enter Time To Be Taken " name="time" required>
                                            <select style="width: 49.5%; font-size: 17px;height: 40px;" name="period" required>
